...
public class GameOptionsMixin {
	...
	@Redirect(method = "Lnet/minecraft/client/options/GameOptions;setValue(Lnet/minecraft/client/options/GameOptions$Option;I)V", at = @At(value = "FIELD", target = "Lnet/minecraft/client/options/GameOptions;guiScale:I", ordinal = 0, opcode = Opcodes.PUTFIELD))
	private void fixMaxGuiScale(GameOptions instance, int oldPut, @Local(ordinal = 0) int value){
