...
public interface AsyncScreenshotReaderWriter {
	 ...
	 *
	 * @param outputFile This is the file that Niterucks has created for your writer to write to using {@link Files#write(Path, byte[], OpenOption...)} or otherwise
	 * @param width      The integer width of the game window in pixels.
	 * @param height     The integer height of the game window in pixels.
	 * @param pixelData  The pixel data object that you have created using {@link #mainThreadReadPixelData(int, int)} passed in as an Object.
	 * @return A message to be displayed in chat after you're done writing your screenshot file.
	 */
	 ...
	 * @param width  The integer width of the game window in pixels.
	 * @param height The integer height of the game window in pixels.
	 * @return The pixel data object you want to store.
	 */
	 ...
	 *
	 * @return The file extension your {@link AsyncScreenshotReaderWriter} uses.
	 */
	 ...
	 *
	 * @param imagePath The image path for your reader writer to read from.
	 * @return The completed BufferedImage.
	 */
